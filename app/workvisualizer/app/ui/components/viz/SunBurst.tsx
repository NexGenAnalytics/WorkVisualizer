...
export const dataRequirements = {
    endpoint: '/api/hierarchy', // API endpoint for this component's data
...
const SunBurst = ({ data }) => {
    ...
    useEffect(() => {
        ...
        const color = d3.color("steelblue").brighter(1);
        ...
        .join("path")
            .attr("fill", d => { while (d.depth > 1) d = d.parent; return color; })
